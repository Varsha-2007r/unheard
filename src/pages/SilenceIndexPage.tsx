...
export const SilenceIndexPage: React.FC = () => {
  ...
  return (
    <div className="pt-28 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-12 animate-fadeIn">
      ...
      {/* Main Grid: Circular Iceberg Gauge & Parameter Simulator */}
          ...
          <div className="relative w-64 h-64 sm:w-72 sm:h-72 flex items-center justify-center my-2">
            <svg className="w-full h-full -rotate-90">
              ...
              <circle
                ...
                cy="50%"
                r="90"
                stroke="url(#silenceGradientPage)"
                strokeWidth="16"
                strokeDasharray={`${circumference}`}
              ...
              />
              <defs>
                <linearGradient id="silenceGradientPage" x1="0%" y1="0%" x2="100%" y2="100%">
